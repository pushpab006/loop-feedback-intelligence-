#!/usr/bin/env node
import { a as executionDiagnostics, l as DOCS_BASE, o as executorLoadFailure, t as notOk$1 } from "./result-8JIfIz1C.mjs";
import { t as alchemyCommandLine } from "./run-alchemy--ZIvgqyU-DjOPkNk-.mjs";
...
async function deployWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-deploy-destroy-5sr2Z9oW-C7fFHLH7.mjs");
	} catch (error) {
...
async function devWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-dev-B8CNl38E-DYxJchU7.mjs");
	} catch (error) {
...
async function logWithDeps(input, deps) {
	...
	let executor;
	try {
		executor = await import("./execute-log-BHrslCk8-CVBBPbon.mjs");
	} catch (error) {
...
//#endregion
//#region ../../0-framework/3-tooling/cli/dist/engine-cli-X_xrCar3.mjs
/**
...
//#endregion
//#region ../../0-framework/3-tooling/cli/dist/cli-CZ2ENVcY.mjs
/**
